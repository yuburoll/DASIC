...
- [거버 폴더](../gerber) 안의 [dasic375-gerber.zip(솔더링판)](../gerber/solder/dasic375-gerber.zip)이나  [dasic375Hotswap-gerber.zip(핫스왑판)](../gerber/hotswap/dasic375Hotswap-gerber.zip)을 다운로드 받아 사이트에 올려주시면 됩니다.
...
- JLCPCB에 맡길 땐 거버 폴더[(솔더링판 및 백플레이트)](../case/platesGerber)안의 하위 폴더들에서 원하는 도면의 거버 압축 파일을 다운로드 받아 사이트에 업로드하면 됩니다. https://jlcpcb.com/
...
- JLC3dp에서 맡기면 약 8~15달러에 한 쪽씩 sls 레진으로 제조해 줍니다. 위의 pcb 보드와 같이 구매해주세요. https://jlc3dp.com/

- 아니면, 직접 fdm 3d 프린팅해서 만들거나 출력대행을 찾아서 프린팅해 저렴하게 구성해도 좋습니다.
...
- 국내(SMD): https://smartstore.naver.com/parts_world/products/8350720438
