...
기존 버젼은 썸클러스터 부분의 길이가 4u이지만, 이 버젼은 3.75u이며 핫스왑 기판에 제약이 없습니다.

실제 레이아웃이 어떻게 보여지는지는 기본 키맵 항목에 있는 키배치를 참고해주세요.
...
- 키캡 세트, 텐키리스 ANSI 레이아웃 (일부 커스텀 키보드 배열도 가능)
...
![dasicHotswapPCB](images/dasicHotswapPCB.png)
