...
- JLCPCB에 맡길 땐 [거버 폴더](../case/platesGerber/) 안의 하위 폴더들에서 원하는 도면의 거버 압축 파일을 다운로드 받아 사이트에 업로드하면 됩니다. https://jlcpcb.com/
...
## 3d 프린팅된 케이스와 0.5u 블로커

- JLC3dp에서 맡기면 약 5달러에 한 쪽씩 sls 레진으로 제조해 줍니다. 위의 pcb 보드와 같이 구매해주세요. https://jlc3dp.com/
...
- fdm 출력에는 bridged라고 표기되어있는 쪽이 좋습니다.
...
- 국내: https://smartstore.naver.com/sagaklabs/products/9085223192
