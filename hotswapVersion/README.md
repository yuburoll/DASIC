...
이 폴더는 다식의 핫스왑 버젼의 정보를 담고 있습니다.

### 주의사항

- 이 버젼은 PCB와 보강판의 배열이 살짝 다릅니다. 이 폴더 안에 있는 내용물을 사용해주세요.

- 케이스와 백플레이트, 블로커, 펌웨어는 동일한 걸 사용합니다. 상위 폴더의 내용물을 사용해주세요.

- 카일 핫스왑 소켓, 혹은 이와 호환되는 핫스왑 소텟이 필요합니다.

- 여전히 2.25u 쉬프트 포지션의 키는 스플릿하거나 합칠 수 있습니다.

- 엄지 4u 키 레이아웃은 납땜판과는 달리 바꿀 수 없습니다. 왼손은 1.25u/2.75u로 고정되고, 오른손은 2u/1u/1u로 고정됩니다.

- Caps/Enter도 서로 다른 키캡으로 바꿀 수 없습니다.

- 스페이스 바 포지션의 핫스왑 소켓을 납땜할 땐 주의해주세요. 패드 조각이 조금밖에 남지 않아서, 좀 더 단단하게 땜하셔야 합니다.
